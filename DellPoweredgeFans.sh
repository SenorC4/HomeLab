...
ipmitool -I lanplus -H 192.168.1.19 -U root -P calvin raw 0x30 0x30 0x01 0x00

# Set fan speed to hex 0x14 == 20% fan speed
ipmitool -I lanplus -H 192.168.1.19 -U root -P calvin raw 0x30 0x30 0x02 0xff 0x17
